...
min_target_heart_rate = max_heart_rate * 0.65
max_target_heart_rate = max_heart_rate * 0.85
print(f"When you exercise to strengthen your heart, you should keep your heart rate between {min_target_heart_rate:.1f} and {max_target_heart_rate:.1f} beats per minute.")